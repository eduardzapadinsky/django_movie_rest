...
class Movie(models.Model):
    ...
    budget = models.PositiveIntegerField("Бюджет", default=0, help_text="Вказати суму в доларах")
    fees_in_usa = models.PositiveIntegerField("Збори в США", default=0, help_text="Вказати суму в доларах")
    fees_in_world = models.PositiveIntegerField("Збори у світі", default=0, help_text="Вказати суму в доларах")
